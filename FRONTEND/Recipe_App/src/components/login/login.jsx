...
function Login() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await axios.post('https://localhost:7105/api/User/login', {
        usertype: userType,
        email: email,
        password: password
      });
          ...
          <div className="card card-2">
            ...
            <div className="card-body">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="input-group">
                  <div className="rs-select2 js-select-simple select--no-search">
                    <select className="slctClss" name="userType" id="userType" value={userType} onChange={changeUser} required>
                      ...
                      <option className="slctClss" value="CHEF">Chef</option>
                ...
                <div className='mt-2'>
                  <p><a style={{color: 'red', fontWeight: 500}} href='/'>Click here signup</a></p>
                </div>
              </form>
            </div>
          </div>
